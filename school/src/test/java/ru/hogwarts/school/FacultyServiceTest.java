...
public class FacultyServiceTest {
    ...
    public void findByColorTest() {
        List<Faculty> faculty = new ArrayList<>(List.of(
                out.writeFaculty(new Faculty(1L, "Harry Potter","Gryffindor")),
                out.writeFaculty(new Faculty(2L, "another one1", "Gryffindor"))
        ));
        out.writeFaculty(new Faculty(3L, "someone else", "Slytherin"));
        List<Faculty> result = new ArrayList<>(out.findByColor("Gryffindor"));
        assertEquals(faculty, result);
    }
    @Test
